...
xmessage "Minecraft launcher (tlauncher legacy) has been installed and will launch now! You can now click "Minecraft" in the application launcher to open it"
